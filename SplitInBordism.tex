...
In this brief section, we remark that the $\mathbb{A}_\infty$ splitting $$\Sigma^{\infty}_+ \Omega SU(n) \simeq gr(\{F_{n,k}\})$$ becomes $\mathbb{E}_2$ after base-change to complex bordism.  More precisely, we show that there is an equivalence of $\mathbb{E}_2$-$MU$-algebras
$$MU \smsh \Sigma^{\infty}_+ \Omega SU(n) \simeq MU \smsh gr(\{F_{n,k}\}).$$
...
\Sigma_+^{\infty} \Omega SU(n) \longrightarrow MU \smsh gr(\{F_{n,k}\}).
\end{equation}
