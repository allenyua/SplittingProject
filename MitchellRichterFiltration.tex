...
We end this section by proving the second part of Theorem \ref{thm:MainMUE2}:

\begin{lem} \label{lem:E2GrConstruction}
...
\begin{proof}
Consider the sequence of $\mathbb{E}_2$-algebras in spaces
$$\coprod F_{n,k} \longrightarrow \Omega U(n) \longrightarrow BU \times \mathbb{Z},$$
where the first arrow is given by group completion.  Taking Thom spectra, one obtains a graded $\mathbb{E}_2$-ring spectrum
$\text{Thom}(\coprod F_{n,k}).$
It is proven in \cite[1.7]{Segal} that this Thom spectrum is equivalent (as a spectrum) to $gr(\Sigma^{\infty}_+ \{F_{n,k}\})$.  We need to show that this is the case as $\mathbb{A}_\infty$-ring spectra.

\textbf{I know you thought about this Allen?  How far did we get?}
\end{proof}