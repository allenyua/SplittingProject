...
It is proven in \cite[1.7]{Segal} that this Thom spectrum is equivalent (as a spectrum) to $gr(\Sigma^{\infty}_+ \{F_{n,k}\})$.  We need to show that this is the case as $\mathbb{A}_\infty$-ring spectra.  \textbf{TODO: Finish this!}
\end{proof}