...
In Appendix \ref{app:SplittingMachine} we make this statement precise (for rigorous definitions of the terms below, see Section \ref{sec:FilGra}):

\begin{thm} %maybe this is an iff
