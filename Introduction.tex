...
such that each composite $A_i \rightarrow A_{i+1} \rightarrow A_i$ is the identity.  In Appendix \ref{app:SplittingMachine} we upgrade this to a multiplicative, coherent statement:

\textbf{***lets be careful, this isn't exactly the same thing we're saying unless things converge properly; what's going on? also need to introduce cofiltered spectra and filtered spectra}
