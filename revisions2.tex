...
\maketitle
We thank the referee for the additional comments.  We have made the following changes in response to the comments:

\begin{itemize}

\item We have included in the Introduction more discussions of the categories of filtered and graded spectra, as suggested.

\item We believe the top line of the pullback below the statement of Corollary 3.19.1 is as intended.  

\item We have fixed the typo in the last paragraph of Section 3 that was pointed out.  
