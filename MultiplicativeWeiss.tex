...
It remains to check that $\text{Tow}$ actually recovers the Weiss tower.  **TBD**.  Maybe let's just say this:
By construction, $\text{Tow}(F)$ is the cofiltered spectrum $$P_0 F\longleftarrow P_1 F \longleftarrow P_2 F \longleftarrow \cdots .$$
