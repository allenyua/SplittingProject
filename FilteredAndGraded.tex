...
where the leftward arrows forget the algebra structure and the downward arrows forget the grading.  The formulas above then show that this square is adjointable, which yields a square %is that standard terminology
%ok...maybe this is all too obvious to need saying.  I should sleep.  
